...
function LbuildEditUI() {
  ...
  ov.innerHTML = `<div class="editSheet"><div class="editHead"><h2>编辑词条</h2><button class="secondary" id="editClose">关闭</button></div><div id="editContent"></div></div>`;
